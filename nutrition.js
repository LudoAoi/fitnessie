export const recipeLibrary = [
    // --- OMNIVORE (Updated) ---
    {
        ...
        diet_tags: ['omnivore', 'flexitarian', 'halal'],
        ...
        prep_time: 30,
        macros: { calories: 550, protein: 50, carbs: 45, fat: 18, fiber: 8, iron: 4, calcium: 100, vitamin_d: 5, potassium: 800, vitamin_b12: 0.6 },
        ingredients: [
    ...
    },
    {
        ...
        prep_time: 25,
        macros: { calories: 580, protein: 45, carbs: 50, fat: 22, fiber: 10, iron: 5, calcium: 80, vitamin_d: 2, potassium: 1200, vitamin_b12: 2.5 },
        ingredients: [
    ...
    },
    {
        ...
        meal_type: ['breakfast'],
        diet_tags: ['omnivore', 'vegetarian', 'pescatarian', 'flexitarian', 'kosher'],
        allergy_tags: [],
        goal_tags: ['maintenance', 'recomp', 'fat_loss'],
        convenience_tags: ['quick_meal', 'under_15_min'],
        prep_time: 10,
        macros: { calories: 450, protein: 28, carbs: 30, fat: 23, fiber: 8, iron: 3.5, calcium: 150, vitamin_d: 10, potassium: 700, vitamin_b12: 1.8 },
        ingredients: [
    ...
    },
    {
        ...
        prep_time: 10,
        macros: { calories: 420, protein: 45, carbs: 10, fat: 22, fiber: 4, iron: 1.5, calcium: 250, vitamin_d: 8, potassium: 600, vitamin_b12: 0.8 },
        ingredients: [
    ...
    },
    {
        ...
        prep_time: 45,
        macros: { calories: 550, protein: 50, carbs: 60, fat: 12, fiber: 12, iron: 3, calcium: 100, vitamin_d: 5, potassium: 1100, vitamin_b12: 0.6 },
        ingredients: [
    ...
    },
    {
        ...
        meal_type: ['dinner'],
        diet_tags: ['omnivore', 'mediterranean', 'halal'],
        allergy_tags: ['gluten_free', 'dairy_free'],
        goal_tags: ['muscle_gain', 'maintenance'],
        convenience_tags: ['one_pan_meal', 'budget_friendly'],
        prep_time: 35,
        macros: { calories: 530, protein: 55, carbs: 40, fat: 15, fiber: 15, iron: 5, calcium: 130, vitamin_d: 5, potassium: 950, vitamin_b12: 0.7 },
        ingredients: [
    ...
    // --- PESCATARIAN (Updated) ---
    {
        ...
        meal_type: ['dinner'],
        diet_tags: ['pescatarian', 'omnivore', 'mediterranean', 'halal', 'kosher'],
        allergy_tags: ['gluten_free', 'dairy_free'],
        goal_tags: ['fat_loss', 'recomp', 'maintenance'],
        convenience_tags: ['one_pan_meal'],
        prep_time: 30,
        macros: { calories: 550, protein: 42, carbs: 40, fat: 25, fiber: 9, iron: 3, calcium: 90, vitamin_d: 25, potassium: 1400, vitamin_b12: 4.0 },
        ingredients: [
    ...
    },
    {
        ...
        prep_time: 10,
        macros: { calories: 450, protein: 40, carbs: 45, fat: 12, fiber: 15, iron: 4, calcium: 120, vitamin_d: 12, potassium: 800, vitamin_b12: 2.5 },
        ingredients: [
    ...
    },
    {
        ...
        prep_time: 15,
        macros: { calories: 500, protein: 40, carbs: 50, fat: 15, fiber: 10, iron: 3.5, calcium: 200, vitamin_d: 12, potassium: 700, vitamin_b12: 2.6 },
        ingredients: [
            { item: 'Canned tuna in water, drained', quantity: 150, unit: 'g' },
    ...
    },
    {
        ...
        prep_time: 15,
        macros: { calories: 450, protein: 45, carbs: 20, fat: 20, fiber: 8, iron: 1.5, calcium: 100, vitamin_d: 15, potassium: 1000, vitamin_b12: 1.5 },
        ingredients: [
    ...
    // --- VEGETARIAN (Updated) ---
    {
        ...
        convenience_tags: ['quick_meal', 'under_15_min'],
        prep_time: 5,
        macros: { calories: 450, protein: 40, carbs: 40, fat: 15, fiber: 10, iron: 2, calcium: 600, vitamin_d: 10, potassium: 500, vitamin_b12: 1.0 },
        ingredients: [
    ...
    },
    {
        ...
        meal_type: ['lunch', 'dinner'],
        diet_tags: ['vegetarian', 'vegan', 'mediterranean', 'halal', 'kosher'],
        allergy_tags: ['gluten_free', 'dairy_free'],
        goal_tags: ['maintenance', 'fat_loss'],
        convenience_tags: ['meal_prep_friendly', 'budget_friendly'],
        prep_time: 30,
        macros: { calories: 520, protein: 25, carbs: 80, fat: 12, fiber: 25, iron: 9, calcium: 200, vitamin_d: 0, potassium: 1500, vitamin_b12: 0 },
        ingredients: [
    ...
    },
    {
        ...
        meal_type: ['lunch', 'dinner'],
        diet_tags: ['vegetarian', 'vegan', 'halal', 'kosher'],
        allergy_tags: ['gluten_free', 'dairy_free'],
        goal_tags: ['fat_loss', 'maintenance'],
        convenience_tags: ['no_cook', 'budget_friendly', 'meal_prep_friendly'],
        prep_time: 15,
        macros: { calories: 480, protein: 20, carbs: 85, fat: 8, fiber: 20, iron: 7, calcium: 150, vitamin_d: 0, potassium: 900, vitamin_b12: 0 },
        ingredients: [
    ...
    },
    {
        ...
        meal_type: ['lunch', 'dinner'],
        diet_tags: ['vegetarian', 'mediterranean', 'kosher'],
        allergy_tags: [],
        goal_tags: ['recomp', 'maintenance'],
        convenience_tags: ['quick_meal', 'under_15_min'],
        prep_time: 15,
        macros: { calories: 480, protein: 30, carbs: 50, fat: 18, fiber: 15, iron: 5, calcium: 200, vitamin_d: 8, potassium: 750, vitamin_b12: 1.2 },
        ingredients: [
    ...
    // --- VEGAN (Updated) ---
    {
        ...
        meal_type: ['lunch', 'dinner'],
        diet_tags: ['vegan', 'vegetarian', 'halal', 'kosher'],
        allergy_tags: ['dairy_free', 'gluten_free'],
        goal_tags: ['muscle_gain', 'recomp'],
        convenience_tags: ['quick_meal', 'under_15_min'],
        prep_time: 15,
        macros: { calories: 420, protein: 30, carbs: 15, fat: 25, fiber: 7, iron: 7, calcium: 500, vitamin_d: 0, potassium: 600, vitamin_b12: 0 },
        ingredients: [
    ...
    },
    {
        ...
        meal_type: ['lunch', 'dinner'],
        diet_tags: ['vegan', 'vegetarian', 'mediterranean', 'halal', 'kosher'],
        allergy_tags: ['gluten_free', 'dairy_free'],
        goal_tags: ['recomp', 'maintenance'],
        convenience_tags: ['meal_prep_friendly', 'no_cook'],
        prep_time: 15,
        macros: { calories: 540, protein: 22, carbs: 70, fat: 20, fiber: 18, iron: 8, calcium: 180, vitamin_d: 0, potassium: 900, vitamin_b12: 0 },
        ingredients: [
            { item: 'Quinoa (cooked)', quantity: 150, unit: 'g' },
    ...
    },
    {
        ...
        prep_time: 20,
        macros: { calories: 500, protein: 20, carbs: 55, fat: 22, fiber: 15, iron: 7, calcium: 100, vitamin_d: 0, potassium: 850, vitamin_b12: 0 },
        ingredients: [
    ...
    },
    {
        ...
        prep_time: 10,
        macros: { calories: 450, protein: 18, carbs: 60, fat: 15, fiber: 12, iron: 6, calcium: 150, vitamin_d: 0, potassium: 700, vitamin_b12: 0 },
        ingredients: [
    ...
    // --- NEW INCLUSIVE RECIPES ---
    {
        id: 'mediterranean_lemon_herb_cod',
        name: 'Lemon Herb Baked Cod with Chickpeas',
        core_ingredients: ['cod', 'chickpea', 'tomato'],
        meal_type: ['dinner'],
        diet_tags: ['omnivore', 'pescatarian', 'mediterranean', 'halal', 'kosher'],
        allergy_tags: ['gluten_free', 'dairy_free'],
        goal_tags: ['fat_loss', 'recomp'],
        convenience_tags: ['one_pan_meal', 'quick_meal'],
        prep_time: 25,
        macros: { calories: 480, protein: 45, carbs: 35, fat: 18, fiber: 12, iron: 3, calcium: 150, vitamin_d: 15, potassium: 900, vitamin_b12: 1.2 },
        ingredients: [
            { item: 'Cod fillet', quantity: 200, unit: 'g' },
            { item: 'Canned chickpeas, rinsed', quantity: 150, unit: 'g' },
            { item: 'Cherry tomatoes, halved', quantity: 100, unit: 'g' },
        ...
        instructions: [
            ...
            'In a baking dish, toss chickpeas and tomatoes with olive oil, oregano, salt, and pepper.',
            'Pat the cod fillet dry and place it on top of the vegetables. Squeeze the juice of half a lemon over the cod.',
            'Bake for 15-20 minutes, until the cod is opaque and flakes easily.',
            'Garnish with fresh parsley and slices from the remaining lemon half before serving.'
        ]
    },
    {
        id: 'south_asian_chickpea_spinach_curry',
        name: 'Chickpea & Spinach Curry (Chana Palak)',
        core_ingredients: ['chickpea', 'spinach', 'tomato'],
        meal_type: ['lunch', 'dinner'],
        diet_tags: ['vegetarian', 'vegan', 'halal', 'kosher', 'mediterranean'],
        allergy_tags: ['gluten_free', 'dairy_free'],
        goal_tags: ['fat_loss', 'maintenance'],
        convenience_tags: ['one_pan_meal', 'budget_friendly', 'meal_prep_friendly'],
        prep_time: 30,
        macros: { calories: 500, protein: 20, carbs: 70, fat: 16, fiber: 20, iron: 8, calcium: 300, vitamin_d: 0, potassium: 1100, vitamin_b12: 0 },
        ingredients: [
            { item: 'Canned chickpeas, rinsed', quantity: 400, unit: 'g' },
            { item: 'Spinach', quantity: 150, unit: 'g' },
            { item: 'Canned diced tomatoes', quantity: 400, unit: 'g' },
            { item: 'Onion, diced', quantity: 1, unit: 'unit' },
        ...
        instructions: [
            'In a large pot, sauté the onion until soft. Add garlic and ginger and cook for another minute until fragrant.',
            'Stir in the garam masala and turmeric. Add the diced tomatoes and cook for 5 minutes.',
            'Add the chickpeas and coconut milk. Simmer for 10 minutes.',
            'Stir in the spinach and cook until wilted, about 2-3 minutes.',
            'Serve hot, ideally with a side of quinoa or brown rice.'
        ]
    },
    {
        id: 'flexitarian_chicken_black_bean_bowl',
        name: 'Chicken & Black Bean Burrito Bowl',
        core_ingredients: ['chicken', 'black bean', 'corn'],
        meal_type: ['lunch', 'dinner'],
        diet_tags: ['omnivore', 'flexitarian', 'halal'],
        allergy_tags: ['gluten_free', 'dairy_free'],
        goal_tags: ['recomp', 'maintenance'],
        convenience_tags: ['meal_prep_friendly', 'one_pan_meal'],
        prep_time: 25,
        macros: { calories: 550, protein: 50, carbs: 55, fat: 15, fiber: 15, iron: 6, calcium: 120, vitamin_d: 5, potassium: 1000, vitamin_b12: 0.7 },
        ingredients: [
            { item: 'Chicken breast, diced', quantity: 180, unit: 'g' },
            { item: 'Canned black beans, rinsed', quantity: 150, unit: 'g' },
            { item: 'Frozen corn', quantity: 100, unit: 'g' },
            { item: 'Quinoa (cooked)', quantity: 100, unit: 'g' },
            { item: 'Salsa', quantity: 4, unit: 'tbsp' },
            { item: 'Avocado', quantity: 0.5, unit: 'unit' },
            { item: 'Chili powder', quantity: 1, unit: 'tsp' }
        ],
        instructions: [
            'Season the diced chicken with chili powder, salt, and pepper.',
            'In a skillet, cook the chicken over medium-high heat until cooked through.',
            'Add the black beans and corn to the skillet and heat for 2-3 minutes.',
            'Serve the chicken and bean mixture over a bed of cooked quinoa.',
            'Top with salsa and sliced avocado.'
        ],
        prep_tip: 'For a plant-based day, simply omit the chicken and double the black beans.'
    },

    // --- SNACKS & DESSERTS (Universal & Updated) ---
    {
        id: 'snack_protein_oats',
        name: 'Quick Protein Oatmeal',
        core_ingredients: ['oat', 'protein powder', 'berry'],
        meal_type: ['breakfast', 'snack'],
        diet_tags: ['omnivore', 'pescatarian', 'vegetarian', 'vegan', 'halal', 'kosher'],
        allergy_tags: ['dairy_free'],
        goal_tags: ['muscle_gain', 'pre_workout'],
        convenience_tags: ['quick_meal', 'under_15_min', 'calorie_dense'],
        prep_time: 5,
        macros: { calories: 450, protein: 35, carbs: 55, fat: 12, fiber: 10, iron: 4, calcium: 150, vitamin_d: 0, potassium: 400, vitamin_b12: 0 },
        ingredients: [
    ...
    },
    {
        ...
        diet_tags: ['omnivore', 'pescatarian', 'vegetarian', 'kosher'],
        allergy_tags: ['gluten_free'],
        goal_tags: ['fat_loss', 'maintenance'],
        convenience_tags: ['quick_meal'],
        season: ['summer'],
        prep_time: 10,
        macros: { calories: 250, protein: 15, carbs: 35, fat: 5, fiber: 5, iron: 0.8, calcium: 200, vitamin_d: 5, potassium: 450, vitamin_b12: 0.5 },
        ingredients: [
    ...
    },
    {
        ...
        season: ['summer'],
        prep_time: 5,
        macros: { calories: 380, protein: 35, carbs: 45, fat: 5, fiber: 8, iron: 3, calcium: 180, vitamin_d: 0, potassium: 600, vitamin_b12: 0 },
        ingredients: [
            { item: 'Protein powder (whey or vegan)', quantity: 30, unit: 'g' },
